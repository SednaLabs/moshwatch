...
namespace Network {
  ...
  private:
    ...
    double SRTT;
    double RTTVAR;
    double last_RTT_sample;

    uint64_t packets_tx_total;
    uint64_t packets_rx_total;
  ...
  public:
    ...
    double get_RTTVAR( void ) const { return RTTVAR; }
    double get_last_RTT_sample( void ) const { return last_RTT_sample; }
    bool has_RTT_sample( void ) const { return RTT_hit; }
    uint64_t get_packets_tx_total( void ) const { return packets_tx_total; }
    uint64_t get_packets_rx_total( void ) const { return packets_rx_total; }
    uint64_t get_send_error_total( void ) const { return send_error_total; }
