...
namespace Network {
  ...
  private:
    ...
    uint64_t retransmits_total;
    uint64_t empty_acks_tx_total;
    uint64_t state_updates_tx_total;
    uint64_t fragments_tx_total;
  ...
  public:
    ...
    uint64_t get_retransmits_total( void ) const { return retransmits_total; }
    uint64_t get_empty_acks_tx_total( void ) const { return empty_acks_tx_total; }
    uint64_t get_state_updates_tx_total( void ) const { return state_updates_tx_total; }
    uint64_t get_fragments_tx_total( void ) const { return fragments_tx_total; }
