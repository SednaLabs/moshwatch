...
namespace Network {
  ...
  private:
    ...
    uint64_t state_updates_rx_total;
    uint64_t duplicate_states_rx_total;
    uint64_t out_of_order_states_rx_total;
  ...
  public:
    ...
    uint64_t get_retransmits_total( void ) const { return sender.get_retransmits_total(); }
    uint64_t get_empty_acks_tx_total( void ) const { return sender.get_empty_acks_tx_total(); }
    uint64_t get_state_updates_tx_total( void ) const { return sender.get_state_updates_tx_total(); }
    uint64_t get_fragments_tx_total( void ) const { return sender.get_fragments_tx_total(); }
    uint64_t get_state_updates_rx_total( void ) const { return state_updates_rx_total; }
    uint64_t get_duplicate_states_rx_total( void ) const { return duplicate_states_rx_total; }
    uint64_t get_out_of_order_states_rx_total( void ) const { return out_of_order_states_rx_total; }
    double get_SRTT( void ) const { return connection.get_SRTT(); }
    double get_RTTVAR( void ) const { return connection.get_RTTVAR(); }
    double get_last_RTT_sample( void ) const { return connection.get_last_RTT_sample(); }
    bool has_RTT_sample( void ) const { return connection.has_RTT_sample(); }
    uint64_t get_packets_tx_total( void ) const { return connection.get_packets_tx_total(); }
    uint64_t get_packets_rx_total( void ) const { return connection.get_packets_rx_total(); }
    uint64_t get_send_error_total( void ) const { return connection.get_send_error_total(); }
